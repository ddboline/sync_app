...
sudo apt-get update
sudo apt-get install -y --force-yes python-boto python-googleapi python-dateutil python-nose python-coverage \
                                    python-onedrivesdk python-setuptools python-dev python-futures
